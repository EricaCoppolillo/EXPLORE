...
if "DGRec" in os.getcwd():
    sys.path.append("../")

from DGRec.utils.EarlyStop import EarlyStoppingCriterion
from DGRec.models.models import DGRec
...
def config(args):
    ...
    early_stop = EarlyStoppingCriterion(patience=args.patience, save_path=save_folder + path + '.pt')
    return early_stop
