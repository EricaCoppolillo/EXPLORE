...
def parse_args():
    ...
    parser.add_argument('--dataset', default = 'KuaiRec-2.0_small', type = str,
                        help = 'Dataset to use')
    ...
    parser.add_argument('--k_list', default = [2, 10, 20], type = list,
    ...
    parser.add_argument('--metrics', default = ['recall', 'hit_ratio'])
